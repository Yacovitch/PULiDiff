...
from lidiff.tools.diff_completion_pipeline_clip import DiffCompletion
from lidiff.utils.histogram_metrics import compute_hist_metrics 
import click
import json

PATH_DATA = '/nas2/jacob/LiDiff/lidiff/Datasets/SemanticKITTI/dataset/sequences/08'
...
@click.option('--diff', '-d', type=str, default='/nas2/jacob/LiDiff/lidiff/experiments/prob10_5p0reg/default/version_119/checkpoints/prob10_5p0reg_epoch=19.ckpt', help='run diffusion pipeline')
